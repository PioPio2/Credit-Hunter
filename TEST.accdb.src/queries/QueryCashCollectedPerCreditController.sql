SELECT
  ...
  Tbl_Customers.Name,
  Query11.[AR Exposure in main currency],
  Query11.Update_date,
  Query11.[Overdue 90+ days],
  Query11.ExchangeRate,
  Tbl_Customer_Status.Status,
  Query11.[Total overdue on fiscal month end],
  Tbl_Customers.Country,
  Query11.[Overdue as of Today in main currency],
...
FROM
  ...
  LEFT JOIN Query11 ON Tbl_Customers.Customer_code = Query11.Customer_ID
GROUP BY
  Tbl_Customers.Customer_code,
  Tbl_Customers.Credit_controller,
  Tbl_Customers.Name,
